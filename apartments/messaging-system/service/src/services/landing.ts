...
${FONT_CSS}
  ...
  *{box-sizing:border-box}
  ...
  body{margin:0;background:#EEEFF1;background-image:linear-gradient(180deg,#F3F4F6,#E6E8EB);
  ...
  .glass{background:linear-gradient(160deg,rgba(255,255,255,.72),rgba(255,255,255,.48));
    ...
    box-shadow:0 10px 30px rgba(17,20,24,.08),inset 0 1px 0 rgba(255,255,255,.85)}
  img{max-width:100%}
  ...
  .btn{display:inline-flex;align-items:center;gap:9px;background:var(--accent);color:#fff;text-decoration:none;
    ...
    box-shadow:0 6px 18px rgba(60,124,100,.28);transition:transform .25s ease,box-shadow .25s ease,background .2s}
  .btn:hover{transform:translateY(-2px);background:var(--accent-dk);box-shadow:0 10px 24px rgba(60,124,100,.34)}
  ...
  /* Cards */
  .card{background:linear-gradient(160deg,rgba(255,255,255,.72),rgba(255,255,255,.48));-webkit-backdrop-filter:blur(20px) saturate(150%);backdrop-filter:blur(20px) saturate(150%);border:1px solid rgba(255,255,255,.7);border-radius:var(--r);padding:18px;
    margin:14px 0;box-shadow:0 10px 30px rgba(17,20,24,.08),inset 0 1px 0 rgba(255,255,255,.85)}
  ...
  /* Selector */
  .seg-wrap{display:flex;gap:6px;background:linear-gradient(160deg,rgba(255,255,255,.6),rgba(255,255,255,.35));-webkit-backdrop-filter:blur(18px) saturate(150%);backdrop-filter:blur(18px) saturate(150%);border:1px solid rgba(255,255,255,.7);padding:6px;border-radius:999px;width:fit-content;margin:0 auto 18px;box-shadow:0 6px 20px rgba(17,20,24,.08),inset 0 1px 0 rgba(255,255,255,.8)}
  ...
  .seg.on{background:var(--card);color:var(--green);box-shadow:0 10px 30px rgba(17,20,24,.08),inset 0 1px 0 rgba(255,255,255,.85)}
  ...
  .step{position:relative;background:linear-gradient(160deg,rgba(255,255,255,.72),rgba(255,255,255,.48));-webkit-backdrop-filter:blur(20px) saturate(150%);backdrop-filter:blur(20px) saturate(150%);border:1px solid rgba(255,255,255,.7);border-radius:var(--r);padding:18px 15px;box-shadow:0 10px 30px rgba(17,20,24,.08),inset 0 1px 0 rgba(255,255,255,.85);display:flex;flex-direction:column;gap:9px;transition:transform .25s ease,box-shadow .25s ease}
  ...
  .svc{display:flex;align-items:center;gap:12px;background:linear-gradient(160deg,rgba(255,255,255,.72),rgba(255,255,255,.48));-webkit-backdrop-filter:blur(20px) saturate(150%);backdrop-filter:blur(20px) saturate(150%);border:1px solid rgba(255,255,255,.7);border-radius:14px;padding:14px 15px;box-shadow:0 10px 30px rgba(17,20,24,.08),inset 0 1px 0 rgba(255,255,255,.85);transition:transform .25s ease,box-shadow .25s ease}
  ...
  .rules li{background:linear-gradient(160deg,rgba(255,255,255,.72),rgba(255,255,255,.48));-webkit-backdrop-filter:blur(20px) saturate(150%);backdrop-filter:blur(20px) saturate(150%);border:1px solid rgba(255,255,255,.7);border-radius:14px;padding:14px 16px;box-shadow:0 10px 30px rgba(17,20,24,.08),inset 0 1px 0 rgba(255,255,255,.85);position:relative;padding-inline-start:44px}
